(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/http'), require('rxjs/add/operator/map'), require('@angular/common'), require('is-retina'), require('ts-md5/dist/md5')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/http', 'rxjs/add/operator/map', '@angular/common', 'is-retina', 'ts-md5/dist/md5'], factory) :
	(factory((global['ngx-avatar'] = {}),global._angular_core,global._angular_http,null,global._angular_common,global.isRetina,global.tsMd5_dist_md5));
}(this, (function (exports,_angular_core,_angular_http,rxjs_add_operator_map,_angular_common,isRetina,tsMd5_dist_md5) { 'use strict';
 ...
 */
var AVATAR_CONFIG = new _angular_core.InjectionToken('avatar.config');
...
AvatarService.ctorParameters = function () { return [
    { type: AvatarConfig, decorators: [{ type: _angular_core.Optional }, { type: _angular_core.Inject, args: [AVATAR_CONFIG,] },] },
...
var Gravatar = (function () {
    ...
    function Gravatar(value) {
        ...
        this.sourceId = value.match('^[a-f0-9]{32}$') ? value : tsMd5_dist_md5.Md5.hashStr(value).toString();
    }
    /**
     * @param {?} size
     * @return {?}
...
var AvatarComponent = (function () {
    ...
    function AvatarComponent(renderer, elementRef, sourceFactory, avatarService) {
        ...
        this.style = {};
        this.cornerRadius = 0;
        this.clickOnAvatar = new _angular_core.EventEmitter();
...
AvatarComponent.propDecorators = {
    'round': [{ type: _angular_core.Input },],
    'size': [{ type: _angular_core.Input },],
    'textSizeRatio': [{ type: _angular_core.Input },],
    'bgColor': [{ type: _angular_core.Input },],
    'fgColor': [{ type: _angular_core.Input },],
    'borderColor': [{ type: _angular_core.Input },],
    'style': [{ type: _angular_core.Input },],
    'cornerRadius': [{ type: _angular_core.Input },],
    'facebook': [{ type: _angular_core.Input, args: ['facebookId',] },],
    'twitter': [{ type: _angular_core.Input, args: ['twitterId',] },],
    'google': [{ type: _angular_core.Input, args: ['googleId',] },],
    'vkontakte': [{ type: _angular_core.Input, args: ['vkontakteId',] },],
    'skype': [{ type: _angular_core.Input, args: ['skypeId',] },],
    'gravatar': [{ type: _angular_core.Input, args: ['gravatarId',] },],
    'github': [{ type: _angular_core.Input, args: ['githubId',] },],
    'custom': [{ type: _angular_core.Input, args: ['src',] },],
    'initials': [{ type: _angular_core.Input, args: ['name',] },],
    'value': [{ type: _angular_core.Input, args: ['value',] },],
    'placeholder': [{ type: _angular_core.Input, args: ['placeholder',] },],
    'initialsSize': [{ type: _angular_core.Input, args: ['initialsSize',] },],
    'clickOnAvatar': [{ type: _angular_core.Output },],
};
